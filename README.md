...
<p align="center">A lightweight, fast, network scanner, for use with basic networks.<br>
Get an up to date list of peer: MAC Address, Vendor, IP Address, and Hostnames<br>
External IP Address and Domain are also displayed in the titlebar after initiating a scan, and a<br>
...
<p align="center"><img src="https://github.com/illsk1lls/IPScanner/blob/main/.readme/ToggleModes.png?raw=true"></p><br>
